...
{
    public class PrivacyPolicy : Entidade
    {
        public PrivacyPolicy(IConfigurationRoot configurationRoot, string filePathToExport) : base(configurationRoot, filePathToExport)
        {
            ColumnsWithoutId =
                @"
                title, 
